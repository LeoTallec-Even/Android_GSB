...
public class AjoutMouvementListe extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ajout_mouvement);
        listView = (ListView) findViewById(R.id.ListeMouvementAjout);
        mouvBdd = new BdAdapteMouvement(this);

        //On ouvre la base de données pour écrire dedans
        mouvBdd.open();
        Cursor leCurseur = mouvBdd.getMouvementAjout();
        ...
        SimpleCursorAdapter dataAdapter = new SimpleCursorAdapter(this, R.layout.affichage_mouvement_ajout, leCurseur,colNoms,colNumeros);
